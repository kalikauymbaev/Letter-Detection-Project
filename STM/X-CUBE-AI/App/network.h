...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "emnist_letters_cnn_int8"
...
#define AI_NETWORK_IN_1_SIZE_BYTES  (784)
...
#define AI_NETWORK_OUT_1_FORMAT      AI_BUFFER_FORMAT_U8
#define AI_NETWORK_OUT_1_CHANNEL     (26)
#define AI_NETWORK_OUT_1_SIZE        (26)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (26)
